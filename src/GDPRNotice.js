  ...
  return (
    <div className="gdpr">
      <div className="gdprText">
        ...
        <p>Vom folosi pozele doar în timpul spectacolului pentru amuzamentul tău sau ca parte din înregistrări sau poze făcute spectacolului, pentru promovare.</p>
        <p>Vom șterge pozele în maxim o zi după spectacol.</p>
      </div>
